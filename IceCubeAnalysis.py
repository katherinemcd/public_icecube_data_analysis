...
class SourceSearch:
    ...
    def __init__(self, icecube_filename):
        ...
        data_ra, data_dec, data_sigmas, data_file_year, data_day = self.load_icecube_data(icecube_filename)
    ...
    def load_icecube_data(self, file_name):
        ...
        data_day = data_day[allowed_entries]
        ...
        return data_ra, data_dec, data_sigmas, data_file_year, data_day
